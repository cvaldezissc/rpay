/**
  * Adds a new user to the table tb_users.
  * 
  * @author cvaldezissc
  ...
  * @param tinyint $p_isadmin [Optional: if this param is null, the procedure will create a new simple user]
...
BEGIN
    ...
    INSERT INTO
        ...
        (
            ...
            , (SELECT CASE p_isadmin WHEN NOT NULL OR 1 THEN 1 ELSE 0 END)
            , 1
            , (NOW())
            , (NOW())
        );
